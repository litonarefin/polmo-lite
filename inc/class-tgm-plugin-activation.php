...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
    ...
    class TGM_Plugin_Activation {
        ...
        public function init() {
            ...
            // Load class strings.
            $this->strings = array(
                'page_title'                      => esc_html__( 'Install Required Plugins', 'jeweltheme_memorials' ),
                'menu_title'                      => esc_html__( 'Install Plugins', 'jeweltheme_memorials' ),
                'installing'                      => esc_html__( 'Installing Plugin: %s', 'jeweltheme_memorials' ),
                'oops'                            => esc_html__( 'Something went wrong with the plugin API.', 'jeweltheme_memorials' ),
                'notice_can_install_required'     => _n_noop(
                    'This theme requires the following plugin: %1$s.',
                    'This theme requires the following plugins: %1$s.',
                    'jeweltheme_memorials'
                ),
